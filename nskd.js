...
//   params: {fromStationCode: 'NZB', toStationCode: 'sc'},
//   headers: {
...
// axios.request(options).then(function (response) {
// 	console.log(response.data.data[0].run_days);
...
//   params: {trainNo: '17405', startDay: '0'},
//   headers: {
//     'X-RapidAPI-Key': 'dae1c185fbmsh95be9cdf96fd443p13e64ejsndb7c59e57250',
//     'X-RapidAPI-Host': 'irctc1.p.rapidapi.com'
//   }
...
// axios.request(options).then(function (response) {
// 	console.log(response.data);
//   console.log('Current station name: '+response.data.data.current_station_name+response.data.data.current_station_name.slice(0,-1)+'\nCurrent Station Code:'+response.data.data.current_station_code)

//   console.log(response.data.data.upcoming_stations,response.data.data.upcoming_stations[0],response.data.data.upcoming_stations[0]['std'])
...
// console.log(upcoming_stations[1]['std'])
//////////////////////////////////////////////////////////////////////////////////////////
//Ticket Fare
// const axios = require('axios');
...
// console.log(fare.data.general[0]['fare'])
...
seats ={
  ...
  data: [
    ...
    },
    {
      ...
      confirm_probability: 'High',
      current_status: 'GNWL9/WL9.'
    },
    {
      total_fare: 1175,
      date: '27-6-2023',
      current_status: 'AVAILABLE-0006.'
    },
    {
      total_fare: 1175,
      date: '28-6-2023',
